<template>
  <div class="xo-select" ref="select">
    <div :style="{width: `${width}px`}" v-clickoutside="clickOutside">
      <div
      ...
      >
        ...
        >{{`${placeholder ? placeholder : '请选择'}`}}</div>
    ...
    <div class="xo-options_wrap" ref="options" v-show="visible">
      <ul class="options-arrow">
        <slot></slot>
      </ul>
